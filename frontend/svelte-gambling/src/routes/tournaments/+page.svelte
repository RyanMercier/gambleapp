    ...
    {:else}
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {:else}
              ...
              {:else}
                <div class="text-center py-12">
                  ...
                  <p class="text-gray-400">Check back later to see completed tournaments and winners!</p>
                </div>
              {/if}
            {/if}
          </div>
        ...
        <div class="space-y-6">
          <!-- User Balance -->
          <div class="card">
            <h3 class="text-lg font-semibold mb-3">💰 Account Balance</h3>
            <div class="text-2xl font-bold text-emerald-400">{formatCurrency($user?.balance || 0)}</div>
            <p class="text-sm text-gray-400 mt-1">Available for tournament entries</p>
          </div>

          <!-- Top Traders -->
          <div class="card">
            <h3 class="text-lg font-semibold mb-3">🏆 Top Traders</h3>
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div class="text-xs text-gray-400">Portfolio: {formatCurrency(trader.portfolio_value || 0)}</div>
                      </div>
                    </div>
                    <div class="text-right">
                      <div class="text-sm font-medium text-emerald-400">{formatCurrency(trader.total_value || 0)}</div>
          ...
          <!-- Quick Stats -->
          <div class="card">
            <h3 class="text-lg font-semibold mb-3">📊 Platform Stats</h3>
            <div class="space-y-2">
              <div class="flex justify-between text-sm">
                <span class="text-gray-400">Active Tournaments:</span>
                <span class="font-medium">{activeTournaments.length}</span>
              </div>
              <div class="flex justify-between text-sm">
                <span class="text-gray-400">Total Prize Pool:</span>
                <span class="font-medium text-emerald-400">
                  {formatCurrency(activeTournaments.reduce((total, t) => total + t.prize_pool, 0))}
                </span>
              </div>
              <div class="flex justify-between text-sm">
                <span class="text-gray-400">Active Traders:</span>
                <span class="font-medium">{activeTournaments.reduce((total, t) => total + (t.current_participants || 0), 0)}</span>
              </div>
            </div>
          </div>
        </div>
